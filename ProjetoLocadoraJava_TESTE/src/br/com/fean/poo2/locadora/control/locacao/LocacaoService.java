...
public interface LocacaoService {
    ...
    public void inserirLocacao(Dependente dependentes, Funcionario funcionarios, Socio socios, Date data2, Date hora, Double valortotal) throws Exception;//Inserir
